...
const ach = require('../models/pet.model')

/* All pets from Firebase */
router.get('/retrieve', async (req, res) => {
    await ach.retrievePets()
...
router.put('/:id', async (req, res) => {
    const id = req.params.id
    await ach.updatePet(id, req.body)
    .then(pet => res.json({
